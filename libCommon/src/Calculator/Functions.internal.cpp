...
std::vector<calculator::InternalFunction> calculator::internalFunctions = {
    // calculator::InternalFunction("Add", calculator::OperatorType::Add"+", 0, false, FunctionOperatorAdd),
    // calculator::InternalFunction("Sub", calculator::OperatorType::Sub"-", 0, false, FunctionOperatorSub),
    // calculator::InternalFunction("Mul", calculator::OperatorType::"*", 0, false, FunctionOperatorMul),
    // calculator::InternalFunction("Div", calculator::OperatorType::"/", 0, false, FunctionOperatorDiv),
    // calculator::InternalFunction("Mod", calculator::OperatorType::"%", 0, false, FunctionOperatorMod),
    // calculator::InternalFunction("Pow", calculator::OperatorType::"^", 0, false, FunctionOperatorPow),
    // calculator::InternalFunction("Equal", calculator::OperatorType::"==", 0, false, FunctionOperatorEqual),
    // calculator::InternalFunction("NotEqual", calculator::OperatorType::"!=", 0, false, FunctionOperatorNotEqual),
    // calculator::InternalFunction("Greater", calculator::OperatorType::">", 0, false, FunctionOperatorGreater),
    // calculator::InternalFunction("GreaterEqual", calculator::OperatorType::">=", 0, false, FunctionOperatorGreaterEqual),
    // calculator::InternalFunction("Less", calculator::OperatorType::"<", 0, false, FunctionOperatorLess),
    // calculator::InternalFunction("LessEqual", calculator::OperatorType::"<=", 0, false, FunctionOperatorLessEqual),
    // calculator::InternalFunction("EqualWithType", calculator::OperatorType::"===", 0, false, FunctionOperatorEqualWithType),
    // calculator::InternalFunction("NotEqualWithType", calculator::OperatorType::"!==", 0, false, FunctionOperatorNotEqualWithType),
    // calculator::InternalFunction("Not", calculator::OperatorType::"!", 0, false, FunctionOperatorNot),
    // calculator::InternalFunction("And", calculator::OperatorType::"&", 0, false, FunctionOperatorAnd),
    // calculator::InternalFunction("Or", calculator::OperatorType::"|", 0, false, FunctionOperatorOr),
    // calculator::InternalFunction("Bool", calculator::OperatorType::"?", 0, false, FunctionOperatorBool),
    // calculator::InternalFunction("Length", calculator::OperatorType::"#", 0, false, FunctionOperatorLength),
