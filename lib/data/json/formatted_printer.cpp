...
void json::formatted_printer::set_compact_style(bool printCompact)
{
    this->print_compact = printCompact;
}

bool json::formatted_printer::is_compact_style() const
{
    return this->print_compact;
}
